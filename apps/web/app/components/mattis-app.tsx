  ...
  return (
    <div className="app-shell">
      ...
      <main className="page-wrap narrow app-content">
        ...
        <p className="secondary-text">
          Ta bilde av oppgavene, eller velg bilder du allerede har på mobilen.
        </p>
        <section className="capture-box section">
          ...
          <div className="capture-actions">
            <label className="button secondary" htmlFor="homework-camera">
              <Icon name="camera" /> Ta bilde
            </label>
            <label className="button secondary" htmlFor="homework-upload">
              <Icon name="image" /> Last opp
            </label>
          </div>
          <input
...
function SessionScreen({
  ...
  function selectChatImage(file: File | null) {
    if (!file) return;
        ...
        <div className="chat-log" aria-live="polite" ref={chatLogRef}>
          ...
          {setupStep === 'photos' ? (
            <div className="setup-upload-card">
              ...
              <div className="setup-upload-actions">
                <label
                  className="button secondary setup-upload-button"
                  htmlFor="session-homework-camera"
                >
                  <Icon name="camera" size={19} /> Ta bilde
                </label>
                <label
                  className="button secondary setup-upload-button"
                  htmlFor="session-homework-upload"
                >
                  <Icon name="image" size={19} /> Velg fra mobilen
                </label>
              </div>
              <input
                className="file-input"
                id="session-homework-camera"
                type="file"
                accept="image/jpeg,image/png,image/webp"
                capture="environment"
            ...
            <>
              ...
              <div className="composer">
                <label
                  ...
                  htmlFor="session-chat-camera"
                  aria-label="Ta bilde av utregningen"
                >
                  <Icon name="camera" size={20} />
                </label>
                <input
                  className="file-input"
                  id="session-chat-camera"
                  type="file"
                  accept="image/jpeg,image/png,image/webp"
                  capture="environment"
                  onChange={(event) => {
                ...
                <label
                  className="composer-attach"
                  htmlFor="session-chat-upload"
                  aria-label="Velg bilde av utregningen"
                >
                  <Icon name="image" size={20} />
                </label>
                <input
                  className="file-input"
                  id="session-chat-upload"
                  type="file"
                  accept="image/jpeg,image/png,image/webp"
                  onChange={(event) => {
                    const file = event.currentTarget.files?.[0] ?? null;
